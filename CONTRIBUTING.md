...
Unit test cases should be added to cover the new code. For PR in [Ratify](https://github.com/ratify-project/ratify), patch coverage is required to be over 80%.
